...
*TIP: keep all template-related sheets in the same document ([Data Catalog Sample Tag Template](https://docs.google.com/spreadsheets/d/1DoILfOD_Fb1r5otEz2CUH8SKGkyV5juLakGODTTfOjY) for reference).*
